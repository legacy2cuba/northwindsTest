...
@Table(name = "alphabetical_list_of_products")
@Entity(name = "northwindsTest$AlphabeticalListOfProducts")
public class AlphabeticalListOfProducts extends BaseLongIdEntity {
