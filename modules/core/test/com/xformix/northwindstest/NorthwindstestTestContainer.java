package com.xformix.northwindstest;
...
public class NorthwindstestTestContainer extends TestContainer {

    public NorthwindstestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/xformix/northwindstest/app.properties",
    ...
    public static class Common extends NorthwindstestTestContainer {

        public static final NorthwindstestTestContainer.Common INSTANCE = new NorthwindstestTestContainer.Common();
